...
const SECTIONS: HelpSection[] = [
  ...
  },
  {
    ...
    body: [
      ...
      'Morning Anchor, OCD Wind Down, and Thought Record entries show how long the entry actually took next to its date, timed live while writing. Quick prompts don\'t show a duration since that mode has no timer to begin with.',
